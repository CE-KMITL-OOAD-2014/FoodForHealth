								...
								<table class="table table-bordered">
										<form>
											...
											<tr>
												...
												<td><input type="number" name="weight" required> kg</td>
											</tr>
											<tr >
												<td>
												<span class="label label-info" style=" width:100%; display:block;">
												...
												<td><input type="number" name="height" required> cm</td>
											</tr>
											<tr >
												<td>
												<span class="label label-info" style=" width:100%; display:block;">
											...
											<tr>
												...
												<td>
													<input buttom class = "btn btn-warning" type="submit" href="home" Submit>
